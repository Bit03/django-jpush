...
class CtrlTagAPIView(DJPushBasicClass, APIView):
    def post(self, request):
        ...
        res = self.my_device.set_deviceinfo(
            registration_id=reg_id, entity=entity
        )
        return Response(res.payload)
...
class DeviceAPIView(DJPushBasicClass, APIView):
    ...
    def post(self, request):
        ...
        res = self.my_device.set_devicemobile(
            registration_id=reg_id, entity=entity
        )
        return Response(res.payload)
...
class TagCheckAPIView(DJPushBasicClass, APIView):
    def get(self, request):
        ...
        res = self.my_device.check_taguserexist(
            tag=tag, registration_id=reg_id
        )
        return Response(res.payload)
